package com.example.androidproject.chatlist
...
import com.example.androidproject.DBKey.Companion.CHILD_CHAT
import com.example.androidproject.DBKey.Companion.DB_USERS
import com.example.androidproject.R
import com.example.androidproject.chatdetail.ChatRoomActivity
...
class ChatListFragment:Fragment(R.layout.fragment_chatlist) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chatDB = com.google.firebase.Firebase.database.reference.child(DB_USERS).child(auth.currentUser!!.uid).child(CHILD_CHAT)
